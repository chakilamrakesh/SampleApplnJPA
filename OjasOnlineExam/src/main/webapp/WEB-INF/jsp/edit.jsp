	...
	<div class="content_div">
		<div align="center">
			...
			<form:form method="POST" action="save" modelAttribute="user">
				...
				<table align="center">
					<tr>
						<td colspan="1" rowspan="1"><font color="Black">User
								Id</font></td>
						<td><font color="Black"><input type="text"
								name="userId" value=<%=request.getAttribute("id")%>
					...
					<tr>
						...
						<td><font color="Black"><input type="text"
								name="technology"></font></td>
					</tr>
					<tr>
						<td><font color="Black">Experience</font></td>
						<td><font color="Black"><input type="text"
								name="experience"></font></td>
					</tr>
					<tr>
						<td><font color="Black">Qualification</font></td>
						<td><font color="Black"><input type="text"
								name="qualification"></font></td>
					</tr>
					<tr>
					...
					<tr>
						<td><font color="Black">UID</font></td>
						<td><font color="Black"><input type="text" name="uid"></font></td>
					</tr>
					<tr>
						<td><font color="Black">DOB</font></td>
						<td><font color="Black"><input type="text" name="dob"></font></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="5"><font color="Blue"><input
								type="submit" value="submit"></font></td>
