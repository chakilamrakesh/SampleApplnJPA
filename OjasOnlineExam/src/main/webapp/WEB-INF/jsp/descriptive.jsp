				...
				<div class="navbar-collapse collapse">
					<div class="menu">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li ><a href="getAllQuestions" class="active">View Questions
							</a>
								</li>
							<li role="presentation"><a href="/OjasOnlineExam/getAllUsersByAdmin">Manage
									User</a></li>
		...
		<form:form action="saveEmployee" method="post"
			...
			<table>
				...
				<tr>
					...
					<td><form:textarea rows="3" cols="30" path="question" style="color:black;  resize: none;"/></td>
				</tr>
				
				<tr>
					<td><font color="black">correct option:</font></td>
					<td><form:textarea rows="3" cols="30" path="correctoption" style="color:black; resize: none;"/></td>
				</tr>
				<tr>
					<td><font color="black">Technology:</font></td>
					<td>
					<form:select path="technology" style="color:black;">
				...
				<tr>
					...
					<td>
					<form:select path="questionlevel" style="color:black;">
							<form:option value="none" label="Select" />
