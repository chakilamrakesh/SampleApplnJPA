...
@NgModule({
  declarations: [RmgComponent, ApproveComponent, BenchEmployeesComponent, BookingRequestComponent, EmployeeexperienceComponent, ProposalsComponent, RejectComponent,RmgPipe, RmgreportsComponent, DeployedEmployeesComponent,RmgpipePipe],
  imports: [
    CommonModule,
    RmgRoutingModule,
    FormsModule,
